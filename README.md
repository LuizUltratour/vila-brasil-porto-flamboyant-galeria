# Galeria — Vila Brasil Porto Flamboyant
...
```
assets/
├── PERSPECTIVAS/   # fachada, áreas comuns e ambientes internos dos apartamentos
└── PLANTAS/        # plantas humanizadas por tipologia + implantação
```
...
categories: [
  ...
  { id: 'apartamentos', label: 'Apartamentos' },
  {
    ...
    subs: [
      { id: 'apto-meio', label: 'Apartamento Meio' },
      { id: 'apto-ponta-pcd', label: 'Apartamento Ponta PCD' },
      { id: 'apto-ponta-terreo', label: 'Apartamento Ponta Térreo' },
...
```
s3://skylineip/Tour Virtual/Vila Brasil/galeria-porto-flamboyant/
```

### Upload completo (primeira vez)

```bash
aws s3 sync . "s3://skylineip/Tour Virtual/Vila Brasil/galeria-porto-flamboyant/" \
  --exclude ".git/*" --exclude "*.md" \
  --content-type "text/html" --include "*.html"

aws s3 sync assets/ "s3://skylineip/Tour Virtual/Vila Brasil/galeria-porto-flamboyant/assets/"
```

### Atualizar só os arquivos principais

```bash
aws s3 cp index.html "s3://skylineip/Tour Virtual/Vila Brasil/galeria-porto-flamboyant/index.html" \
  --content-type "text/html"

aws s3 cp inject.js "s3://skylineip/Tour Virtual/Vila Brasil/galeria-porto-flamboyant/inject.js" \
...
```
https://skylineip.s3.amazonaws.com/Tour%20Virtual/Vila%20Brasil/galeria-porto-flamboyant/index.html
https://skylineip.s3.amazonaws.com/Tour%20Virtual/Vila%20Brasil/galeria-porto-flamboyant/inject.js
```
...
<script>
(() => {
  const scriptUrl = 'https://skylineip.s3.amazonaws.com/Tour%20Virtual/Vila%20Brasil/galeria-porto-flamboyant/inject.js';
